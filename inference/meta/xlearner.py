...
from inference.meta.utils import check_control_in_treatment, check_p_conditions
from inference.meta.explainer import Explainer
from metrics import regression_metrics, classification_metrics
from propensity import compute_propensity_score
...
class BaseXLearner(object):
    ...
    def __init__(self,
        ...
        if propensity_model_learner is None:
            self.model_p = None
        else:
            self.model_p = propensity_model_learner
...
class BaseXRegressor(BaseXLearner):
    ...
    def __init__(self,
        ...
        super().__init__(
            ...
            propensity_model_learner=propensity_model_learner,
            ate_alpha=ate_alpha,
